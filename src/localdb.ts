...
export const DEFAULT_DB_NAME = "gtsyncdb";
...
const migrateDBs = async (
  ...
  if (oldVer < 20220326) {
    throw Error(
      "You are using a very old version. No way to auto update internal DB. Please install and enable 0.3.40 firstly, then install a later version."
    );
  }
